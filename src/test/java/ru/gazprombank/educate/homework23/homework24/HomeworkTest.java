...
public class HomeworkTest {
    ...
    void test3() throws Exception {
        ...
        assertEquals(target, result, "Expected string: '{1=1}' actual " + result);
    }
    ...
    void test4() throws Exception {
        ...
        assertEquals(target, result, "Expected string: '{}' actual " + result);
    }
    ...
    void test5() throws Exception {
        ...
        assertEquals(target, result, "Expected string: '{1=3, 2=10, 3=6, 4=9, 5=5, 6=6, 7=6, 8=8, 9=4}' actual " + result);
    }
    ...
    void test7() throws Exception {
        ...
        assertEquals(target, result, "Expected string: '{1=2, 2=1, 3=1, 4=1}' actual " + result);
    }
}
